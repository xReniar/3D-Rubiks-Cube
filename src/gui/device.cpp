...
/*
1) setting up connection with vulkan and picking a physical device that is capable on working with the vulkan API
2) creating validation layers that will help catch errors
*/

Device::Device(CubeGUI &cubeGUI) : cubeGUI{cubeGUI}{
    createInstance();
    setupDebugMessenger();
    createSurface();
    pickPhysicalDevice();
...
void Device::createSurface() { cubeGUI.createWindowSurface(instance, &surface_); }
